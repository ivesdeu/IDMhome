...
export function Footer() {
  return (
    <footer className="w-full bg-white border-t border-border py-16">
      <div className="max-w-[1200px] mx-auto px-6">
        <div className="grid md:grid-cols-4 gap-12 mb-12">
          {/* Info & Address */}
          <div>
            <h3 className="font-bold text-primary mb-4">Marketra®</h3>
            <p className="text-sm text-[#666666] mb-4">
              Performance marketing and growth infrastructure for ambitious brands.
            </p>
            <p className="text-sm text-[#666666]">
              Milwaukee, WI 53211<br />
              growth.marketra@gmail.com
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><a href="#works" className="text-[#666666] hover:text-primary transition-colors">Case Studies</a></li>
        ...
        <div className="border-t border-border pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="font-bold text-primary">Marketra®</div>
        </div>
      </div>
    </footer>
  );
